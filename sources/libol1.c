                     ...
                     itg BasIdx, itg NmbThr)
{
   ...
   for(t=0;t<NmbThr;t++)
   {
      MshThr = msh->thr[t] = NewMem(tre, sizeof(MshThrSct));
      ...
      tre->thr[t] = NewMem(tre, sizeof(OctThrSct));
      memset(tre->thr[t], 0, sizeof(OctThrSct));
   }
